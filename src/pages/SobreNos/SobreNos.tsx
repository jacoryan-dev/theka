      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          <div className={styles.heroArtwork}>
            ...
            >
              <path
                d="M577.696 406.001C577.696 406.001 470.751 405.326 394.778 349.982C486.504 300.584 554.963 177.337 459.258 89.536C357.379 -4.16927 216.749 97.0826 211.769 230.04C211.185 239.138 212.238 275.68 215.953 283.935C96.1621 309.352 41.729 279.027 41.729 279.027L-2.59907 403.36L57.4077 415.53L57.431 415.314C57.431 415.314 58.2 415.616 58.3981 415.637C116.623 423.906 196.045 423.346 279.002 399.392C336.996 456.061 423.402 487.232 498.16 503.836C498.533 504.094 498.929 504.137 499.127 504.158L580.061 519.249L577.696 406.001ZM330.188 191.385C344.233 170.875 385.043 153.046 396.945 187.49C410.721 228.682 364.154 247.852 320.363 256.197C315.567 233.864 317.32 210.278 330.188 191.385Z"
                fill="#F8C200"
              />
              <path
                d="M78.2995 300.592C58.1787 326.687 47.2453 376.661 43.562 403.922C43.1938 406.646 40.7395 408.597 38.006 408.301L-3.23646 403.835C-3.81976 403.772 -4.40656 403.802 -4.96528 403.981C-10.6459 405.802 -22.4332 413.215 -30.3378 430.782C-57.2017 499.139 -94.2519 515.95 -109.419 515.811C-186.146 516.973 -159.794 409.056 -137.027 354.952C-122.97 311.182 -87.5856 221.496 -58.5006 212.918C-29.8079 204.456 22.0197 254.615 45.2956 281.796C45.9214 282.527 46.724 283.046 47.6448 283.326L75.7903 291.863C79.4147 292.962 80.6122 297.593 78.2995 300.592Z"
                stroke="#48001D"
                strokeWidth="20"
              />
              <path
                d="M46.9678 282.128L75.7358 292.377C78.9369 293.518 80.0998 297.455 78.1978 300.271C60.9744 325.771 49.766 363.916 43.1864 404.061C42.754 406.7 40.3425 408.554 37.6847 408.266L-1.88185 403.981C-4.34305 403.715 -6.25118 401.692 -6.22806 399.217C-5.8682 360.681 18.188 299.832 30.2024 274.723C31.6775 271.64 35.7351 271.092 38.0896 273.57L45.0217 280.863C45.5622 281.431 46.2288 281.865 46.9678 282.128Z"
                fill="#48001D"
                stroke="#48001D"
              />
              <path
                d="M540.137 511.987C560.258 485.892 571.191 435.918 574.875 408.657C575.243 405.933 577.697 403.982 580.431 404.278L621.673 408.744C622.256 408.808 622.843 408.777 623.402 408.598C629.082 406.777 640.87 399.364 648.774 381.797C675.638 313.44 712.688 296.629 727.856 296.768C804.582 295.606 778.23 403.523 755.464 457.627C741.407 501.397 706.022 591.084 676.937 599.661C648.244 608.123 596.417 557.965 573.141 530.783C572.515 530.052 571.712 529.533 570.792 529.254L542.646 520.716C539.022 519.617 537.824 514.987 540.137 511.987Z"
                stroke="#48001D"
                strokeWidth="20"
              />
              <path
                d="M571.469 530.451L542.701 520.202C539.5 519.061 538.337 515.124 540.239 512.308C557.462 486.808 568.67 448.663 575.25 408.518C575.683 405.88 578.094 404.025 580.752 404.313L620.318 408.598C622.78 408.864 624.688 410.887 624.665 413.363C624.305 451.898 600.249 512.747 588.234 537.857C586.759 540.939 582.701 541.487 580.347 539.01L573.415 531.716C572.874 531.148 572.208 530.714 571.469 530.451Z"
                fill="#48001D"
                stroke="#48001D"
              />
              <path
                d="M645.945 382.321L678.256 400.674C683.143 403.449 684.754 409.602 681.853 414.417C678.953 419.231 672.64 420.883 667.753 418.108L635.443 399.755L645.945 382.321Z"
                fill="#48001D"
              />
              <path
                d="M659.345 354.187L691.655 372.54C696.542 375.316 698.153 381.469 695.253 386.283C692.352 391.097 686.04 392.75 681.153 389.974L648.842 371.621L659.345 354.187Z"
                fill="#48001D"
              />
              <path
                d="M677.708 327.986L710.019 346.338C714.906 349.114 716.516 355.267 713.616 360.081C710.716 364.895 704.403 366.548 699.516 363.772L667.205 345.419L677.708 327.986Z"
                fill="#48001D"
              />
            </svg>
          </div>
          ...
          <div className={styles.heroTextContainer}>
            ...
            <p className={styles.heroText}>
              A Theka© é um espaço feito para conectar pessoas e histórias. Aqui
              você encontra livros para todos os gostos, além de atividades que
              incentivam o conhecimento, a cultura e a troca de experiências.
              Mais do que estantes cheias, somos um ponto de encontro para quem
              acredita no poder da leitura em transformar vidas.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className={styles.historyCard}>
                <div className={styles.historyContent}>
                  <p className={styles.historyText}>
                    No começo, era apenas uma pequena coleção de livros reunidos
                    com carinho, mas, com o tempo, foi crescendo e conquistando
                    cada vez mais leitores.Hoje, além de guardar histórias nas
                    estantes, também faz parte da história de quem passa por
                    aqui: estudantes, pesquisadores, curiosos e apaixonados por
                    livros. Seguimos firmes na missão de ser um ponto de
                    encontro, aprendizado e inspiração para todos.
                  </p>
                      ...
                      <defs>
                        <clipPath id="clip0_494_1385">
                          <rect
                            ...
                            height="358"
                            fill="white"
                            transform="translate(3.35874e-05 721.39) rotate(-90)"
                          />
                        </clipPath>
                      </defs>
                    </svg>
                ...
                <div className={styles.valueArtwork}>
                  ...
                  >
                    <g clipPath="url(#clip0_494_1725)">
                      ...
                      <path
                        d="M335.803 404.946C305.13 407.859 278.484 396.415 278.484 396.415C215.96 371.109 126.504 330.629 187.73 251.217C213.482 278.332 237.371 297.762 259.644 310.899C369.03 375.415 433.635 286.961 429.471 225.052C422.063 113.526 253.264 88.9059 170.425 147.738L128.637 105.647L102.692 168.309L125.06 191.826C117.067 202.064 109.949 213.53 103.52 225.936C42.7401 344.949 191.223 461.54 295.341 479.873C301.308 480.9 298.654 480.581 300.912 480.667C301.044 480.744 305.537 481.258 305.747 481.204L328.757 482.85L335.803 404.946ZM301.199 194.965C333.19 188.913 379.061 197.278 377.112 220.159C376.602 226.444 374.319 234.532 359.581 241.147C345.425 248.284 310.403 248.632 271.794 230.666C259.232 224.859 252.51 220.895 240.032 211.933C263.613 200.565 273.797 200.163 301.199 194.965Z"
                        fill="#81013A"
                      />
                    </g>
                    <defs>
      ...
      <section className={styles.teamSection}>
        <Container>
          ...
          <Row className={styles.teamGrid}>
            <Col>
              <div
                className={`${styles.teamMember} ${styles.teamMemberOrange}`}
              >
            ...
            <Col>
              <div
                className={`${styles.teamMember} ${styles.teamMemberPurple}`}
              >
                <div className={styles.teamImageWrapper}>
                  <img
                    src="src/assets/member3.png"
                    alt="Jeniffer Oliveira"
                    className={styles.teamImage}
                  />
                </div>
                <div className={styles.teamNameBadge}>
